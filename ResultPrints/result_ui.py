...
class result(object):
    def __init__(self,data,surface):
        ...
        self.score1 = str(data["score1"])
        self.score2 = str(data["score2"])
        ...
        self.dig_font = pygame.font.Font("dig.TTF",25)
        self.big_dig_font =pygame.font.Font("dig.TTF",41)

    def render(self):
        self._background_surface = pygame.image.load("images/result_background.png")
        self._background_surface = pygame.transform.smoothscale(self._background_surface,(480,840))
        ...
        self.surface.blit(self.dig_font.render(self.score1, True, (253, 255, 116)), (410 + 740, 330))

        self.surface.blit(self.dig_font.render(self.score2, True, (253, 255, 116)), (410 + 740, 542))

        self.surface.blit(self.title_font.render("体能评估报告", True, (0,199,140)),
                                (740 + 63, 74))

        self.surface.blit(self.big_font.render("个人信息", True, (86,86,86)),
                                (740 + 61, 143))
        ...
        self.surface.blit(self.big_font.render("身高围度测量", True, (86,86,86)),
                                (61 + 740, 301))
        ...
        self.surface.blit(self.big_font.render("运动能力评估", True, (86,86,86)),
                                 (61 + 740,513))
        ...
        self.surface.blit(self.little_font.render(str(self.down), True, (94, 183, 153)),
                                (340 + 740, 556))

        self.surface.blit(self.big_font.render("肌肉问题分析", True, (86,86,86)),
                                 (61+740, 590))


        self.surface.blit(self.big_font.render("BMI=" ,True ,(0,199,140)),(64+740,433))

        self.surface.blit(self.big_dig_font.render("27.1%", True,(0,199,140)),(120+740,420))

        self.button_red = pygame.image.load("images/rect_red.png")
        self.button_green = pygame.image.load("images/rect_green.png")

        self.button_red = pygame.transform.smoothscale(self.button_red,(200,80))
        self.button_green = pygame.transform.smoothscale(self.button_green,(200,80))
        ...
        self.surface.blit(self.big_font.render("下载评估表",True,(0,199,140)),(606/1080 * 540 + 740,867))
