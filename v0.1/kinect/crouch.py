...
class dumbbell(object):
    ...
    def draw_ui(self):
        ...
        self._frame_surface.blit(self.cn_font.render("哑铃练习", True, (0, 0, 0)), (960, 10))
        self._frame_surface.blit(self.num_font.render("10", True, (0, 0, 0)), (940, 40))
        self._frame_surface.blit(self.cn_font.render("已完成次数", True, (0, 0, 0)), (640, 10))
